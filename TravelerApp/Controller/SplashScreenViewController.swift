...
//  TravelerApp
//
//  Created by Sezgin Çiftci on 4.01.2022.
//
...
class SplashScreenViewController: UIViewController {
    ...
    fileprivate var items = [
        ...
        SplashScreeenItem(title: "Travel the World", content: "During the travel, save your stopping places as well as your destinations!", backgroundImage: UIImage(named: "travel 1")),
        SplashScreeenItem(title: "Use Map Like Old Travelers", content: "Mapping is a kind of old school saving process, enjoy that!", backgroundImage: UIImage(named: "travel 2")),
        SplashScreeenItem(title: "Save Your Comments However You Like", content: "You are able to save your comments as well like travel book!", backgroundImage: UIImage(named: "travel 3"))
    ]
